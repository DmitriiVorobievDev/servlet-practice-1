...
import com.dvdev.http.mvc.entity.Flight;
import com.dvdev.http.mvc.entity.FlightStatus;
import com.dvdev.http.mvc.util.ConnectionManager;
...
public class FlightDao implements Dao<Long, Flight> {
    ...
    //1. Создаем приватный конструктор
    private FlightDao() {
    }

    //делаем класс FlightDao синглтоном
    //2. Создаем один объект
    ...
    @Override
    public List<Flight> findAll() { //метод делает по сути SELECT *
    ...
    private Flight buildFlight(ResultSet resultSet) throws SQLException { //метод билдит строку Flight
        return new Flight(
